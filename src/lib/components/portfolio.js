...
export const greetings = {
  name: "Vaishnav Wakchaure",
  title: "Welcome.",
  description:
    "I am Student / Software Developer, learning Full Stack Web Development and Cyber Security. I have experience building Applications with JavaScript, React,  Vue,  Node and some other cool libraries and frameworks.",
  resumeLink: "myresumelink",
};

export const openSource = {
  githubUserName: "vaishnavw45",
};
...
export const socialLinks = {
  url: "",
  github: "https://github.com/vaishnavw45",
  linkedin: "https://www.linkedin.com/in/vaishnav-wakchaure/",
...
export const educationInfo = [
  {
    ...
    github: "https://github.com/vaishnavw45/Portfolio",
  },
  {
